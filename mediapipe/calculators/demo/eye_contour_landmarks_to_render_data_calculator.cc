#ifndef MEDIAPIPE_CALCULATORS_T_DMS_EYE_CONTOUR_LANDMARKS_TO_RENDER_DATA_CALCULATOR
#define MEDIAPIPE_CALCULATORS_T_DMS_EYE_CONTOUR_LANDMARKS_TO_RENDER_DATA_CALCULATOR
...
class EyeContourLandmarksToRenderDataCalculator : public CalculatorBase {
private:
...
REGISTER_CALCULATOR(EyeContourLandmarksToRenderDataCalculator);
}  // namespace mediapipe
#endif